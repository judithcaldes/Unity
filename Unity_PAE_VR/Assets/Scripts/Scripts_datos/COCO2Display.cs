...
public class COCO2Display : MonoBehaviour
{
    public Text COCO2Text;
    ...
    IEnumerator UpdateCOCO2()
    {
        ...
        while (true)
        {
            if (Hologram1.activeSelf){
                ...
                if (entry != null)
            {
                COCO2Text.text = "" + entry.Value;
            }
            else
            {
                COCO2Text.text = "No data found";
            }
            }
