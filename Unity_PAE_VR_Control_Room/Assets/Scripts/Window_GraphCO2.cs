...
public class Window_GraphCO2 : MonoBehaviour
{
    ...
    private static Window_GraphCO2 instance;
    ...
    { //void
        ...
        FunctionPeriodic.Create(() =>
        {
            ...
            ShowGraph(valueList, lineGraphVisual, -1, (int _i) => "" + (_i), (float _f) => Mathf.RoundToInt(_f) + "ppm");
  ...
  */
    ...
    */
    ...
    private void ShowGraph(List<float> valueList, IGraphVisual graphVisual, int maxVisibleValueAmount = -1, Func<int, string> getAxisLabelX = null, Func<float, string> getAxisLabelY = null)
    {
        ...
        int separatorCount = 22;//del 10 al 30
        int numsep = 0;
