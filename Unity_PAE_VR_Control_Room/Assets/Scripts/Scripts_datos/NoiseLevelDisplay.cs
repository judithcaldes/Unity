...
public class NoiseLevelDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        StartCoroutine(UpdateNoiseLevel());
    }
    ...
    IEnumerator UpdateNoiseLevel()
    {
        ...
        while (true)
        {
            if (Hologram1.activeSelf){
                ...
                if (entry != null)
            {
                noiselevelText.text = "" + entry.Value;
            }
            else
            {
                noiselevelText.text = "No data found";
            }
            }
